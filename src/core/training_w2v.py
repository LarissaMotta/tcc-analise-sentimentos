...
def training(df, df2, df3):
    ...
    matrix_embedding, df, df2, df3 = process_file.process_data_w2v(df, df2, df3)
    ...
    net = LSTM_model.SentimentLSTM(n_vocab, n_embed, n_hidden, n_output, n_layers, matrix_embedding)
